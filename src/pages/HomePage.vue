  ...
  <div>
    <section class="mx-auto max-w-[1600px] px-5 pt-6 md:px-8 lg:px-10">
      <div class="relative overflow-hidden rounded-shell border border-line bg-ink text-paper group">
        ...
        <button
          type="button"
          class="absolute bottom-6 right-6 z-20 hidden md:block rounded-full border border-paper/40 bg-paper/10 px-4 py-2 text-label uppercase tracking-widest text-paper backdrop-blur transition hover:bg-paper hover:text-ink opacity-0 group-hover:opacity-100 focus:opacity-100"
        ...
        <div class="relative grid min-h-[78vh] items-end md:grid-cols-[1.1fr_0.9fr]">
          <div class="z-10 px-6 py-12 sm:px-8 md:px-12 md:py-16 lg:px-16 lg:py-20">
            <p v-reveal class="text-label uppercase tracking-[0.34em] text-paper/60 font-bold">Soutěž v oblasti realit a developmentu</p>
            <h1 v-reveal="100" class="mt-6 max-w-4xl text-display font-medium leading-none tracking-[-0.04em]">
              Realitní<br>projekt roku
            </h1>
            <p v-reveal="200" class="mt-6 max-w-2xl text-body leading-8 text-paper/72 md:text-lead">
            ...
            <div class="mt-14 grid gap-6 border-t border-paper/15 pt-8 sm:grid-cols-2 lg:grid-cols-3">
              <div v-reveal="400">
                <p class="text-label uppercase tracking-[0.28em] text-paper/45 font-bold">Vyhlášení</p>
                <p class="mt-3 text-h2 font-medium tracking-[-0.03em]">Leden 2027</p>
              </div>
              <div v-reveal="500">
                <p class="text-label uppercase tracking-[0.28em] text-paper/45 font-bold">Region</p>
                <p class="mt-3 text-h2 font-medium tracking-[-0.03em]">Celá ČR</p>
              </div>
              <div v-reveal="600">
                <p class="text-label uppercase tracking-[0.28em] text-paper/45 font-bold">Vítěz</p>
          ...
          >
            ...
            <button
              type="button"
              class="z-10 rounded-full border border-paper/40 bg-ink/40 px-6 py-3 text-small tracking-[0.16em] text-paper backdrop-blur transition-all duration-300 pointer-events-none"
    ...
    <section class="border-y border-line bg-paper">
      <div class="mx-auto grid max-w-[1600px] gap-10 px-5 py-20 md:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:px-10 lg:py-24">
        <div v-reveal class="self-center">
          <p class="text-label uppercase tracking-[0.32em] text-secondary font-bold">Realitní Projekt Roku</p>
        ...
        <div class="grid gap-6 sm:grid-cols-2">
          ...
          >
            ...
            <div class="pt-5">
              <h3 class="text-h2 font-medium tracking-[-0.03em] font-bold text-ink">{{ organizer.name }}</h3>
              <p class="mt-2 text-label uppercase tracking-[0.24em] font-bold text-ink/70">{{ organizer.role }}</p>
            </div>
          </article>
        </div>
      </div>
    ...
    <section class="mx-auto max-w-[1600px] px-5 py-20 md:px-8 lg:px-10 lg:py-24">
      <div v-reveal class="mb-12">
        <p class="text-label uppercase tracking-[0.32em] text-secondary font-bold">Projekty v boji o vítězství</p>
        <h2 class="mt-5 text-h1 font-medium tracking-[-0.04em] text-ink">
          Nominované projekty
        </h2>
      </div>
    ...
    <section class="flex flex-col border-y border-line md:flex-row min-h-[500px]">
      ...
      >
        ...
        <div class="relative z-10 flex max-w-sm flex-col items-center">
          <h2 class="mb-6 text-h1 font-bold tracking-[-0.02em] text-ink drop-shadow-[0_4px_10px_rgba(0,0,0,0.1)] transition-transform duration-500 group-hover:scale-105">Pro developery</h2>
      ...
      >
        ...
        <div class="relative z-10 flex max-w-sm flex-col items-center">
          <h2 class="mb-6 text-h1 font-bold tracking-[-0.02em] text-paper drop-shadow-[0_4px_10px_rgba(0,0,0,0.5)] transition-transform duration-500 group-hover:scale-105">Pro partnery</h2>
